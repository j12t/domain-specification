...
/**
 * Specification to check if a parameter (or a complex function called on a <T> object) referencing a date is after a value
 * 
 * @author J12T
 *
 * @param <T>
 */
public class DateAfterSpecification<T> extends AbstractDomainSpecification<T> {
	 ...
	 */
	public DateAfterSpecification(String name, Function<T, Date> function, Date value) {
		setName(name);
